...
class searchStudent extends JFrame{
	...
	searchStudent(StudentCollection studentc){
		...
		JLabel mainL = new JLabel("Search Student ",SwingConstants.CENTER);
		mainL.setFont(new Font("Arial",Font.BOLD,15));
		mainL.setForeground(Color.WHITE);
		mainL.setBackground(Color.BLUE);
		...
		btn.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				int index = studentc.searchStudent(IdField.getText());
				if(index !=-1){
